...
func NewGuiDisplay(width, height int, keyboard chip8.Keyboard) *guiDisplay {
...
func (g *guiDisplay) Run() error {
	g.window.ShowAndRun()
	return nil
}

func NewDefaultGuiDisplay(keyboard chip8.Keyboard) *guiDisplay {
